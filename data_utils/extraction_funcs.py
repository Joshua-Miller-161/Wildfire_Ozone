...
#====================================================================
#====================================================================
def ExtractHDF5_v2(path, var_names, groups=None, print_sum=False):
    '''
    ...
    #----------------------------------------------------------------
        ...
        for group in groups:
            if print_sum:
                print(' - + - + - + - Examining group \''+group+'\' - + - + - + -')
                #PrintSumHDF5(path, f=f[group])
            for var_name in var_names:
                if (type(f[group]) == h5py.Dataset):
                    var = f[group]
                    var_dict[var_name] = var[()]
                else:
